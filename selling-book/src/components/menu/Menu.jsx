...
const Menu = ({ menuList }) => {
  ...
  return (
    <label className="left-0 cursor-pointer">
      ...
      <ul className="invisible opacity-0 peer-checked:visible peer-checked:opacity-100 Transition flex flex-col gap-[2px] absolute top-7 z-10 left-0 bg-COLOR_3 rounded-[10px] border border-COLOR_3 overflow-hidden shadow-xl shadow-COLOR_3">
        {
